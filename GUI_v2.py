...
# Shadow effect for input message
input_shadow = Text(input_frame, height=8, width=68, wrap="word", bg="#d9d9d9")
input_shadow.place(x=2, y=2)
...
# Shadow effect for output message
output_shadow = Text(output_frame, height=8, width=68, wrap="word", bg="#d9d9d9")
output_shadow.place(x=2, y=2)
